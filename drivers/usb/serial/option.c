...
#define ZTE_PRODUCT_ME3760_V2			0x0199
...
static struct usb_device_id option_ids[] = {
	...
	{ USB_DEVICE(ZTE_VENDOR_ID, ZTE_PRODUCT_ME3760_V2) },//ZTE_PRODUCT_ME3760_V2
			...
			const struct usb_device_id *id)
{
	...
	if (serial->dev->descriptor.idVendor == ZTE_VENDOR_ID &&
		serial->dev->descriptor.idProduct == ZTE_PRODUCT_ME3760_V2 &&
